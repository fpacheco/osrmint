...
'http://127.0.0.1:5000/viaroute');
-- 2
SELECT id, tdist, ttime FROM osrmint_route('SELECT * FROM route RANDOM LIMIT 50','http://127.0.0.1:5000/viaroute');
SELECT id, tdist, ttime INTO TEMP pepe2 FROM osrmint_route('SELECT * FROM route RANDOM LIMIT 50','http://127.0.0.1:5000/viaroute');
